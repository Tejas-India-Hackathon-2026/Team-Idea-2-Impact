...
export const DeliveryPartnerView: React.FC = () => {
  const { deliveryTasks, updateDeliveryTaskStatus } = useApp();

  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', paddingBottom: '40px' }}>
      <div style={{ background: '#0f172a', color: '#ffffff', borderRadius: '16px', padding: '24px' }}>
        <h1 style={{ fontSize: '20px', fontWeight: 800 }}>Ramesh Express Delivery Partner Hub</h1>
        <p style={{ fontSize: '12px', color: '#94a3b8', marginTop: '2px' }}>Koramangala Hyperlocal Delivery Radius (8 km)</p>
      </div>
